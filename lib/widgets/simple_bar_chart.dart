...
class SimpleBarChart extends StatelessWidget {
    ...
    return FlTitlesData(
      ...
      bottomTitles: AxisTitles(
        sideTitles: SideTitles(
          ...
          getTitlesWidget: (value, _) {
            ...
            return Padding(
              padding: const EdgeInsets.only(top: 6),
              child: Text(xLabels[i], style: const TextStyle(fontSize: 11)),
            );
          },
        ),
      ),
      ...
      leftTitles: AxisTitles(
        ...
        sideTitles: SideTitles(
          ...
          getTitlesWidget: (value, _) {
            final v = value.toInt();
            return Text(showNaira ? '₦$v' : v.toString(),
                style: const TextStyle(fontSize: 11));
          },
        ),
      ),
  ...
  double _niceInterval(double maxY, double minY) {
    final raw = (maxY - minY) / 4;
    final magnitude = pow(10, log(raw) ~/ ln10);
    return (raw / magnitude).ceil() * magnitude.toDouble();
  }
}
