...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalEggsCollected = monthLogs.fold(0, (s, l) => s + l.eggsCollected);
      ...
      body: ListView(
        ...
        children: [
          ...
          _SummaryCard(title: 'Profit & Loss', rows: [
            _Row('Total Income', formatMoney(totalIncome),
                Colors.green.shade700),
            _Row('Total Expenses', formatMoney(totalExpenses),
                Colors.red.shade500),
            _Row('Net Profit', formatMoney(netProfit),
                netProfit >= 0 ? Colors.green.shade700 : Colors.red,
                bold: true),
          ]),
          ...
          _SummaryCard(title: 'Egg Summary', rows: [
            _Row('Eggs Collected', formatEggs(totalEggsCollected),
                Colors.grey.shade700),
            _Row('Eggs Sold', formatEggs(totalEggsSold), Colors.grey.shade700),
            _Row(
                'Eggs on Hand',
                formatEggs(
                    (totalEggsCollected - totalEggsSold).clamp(0, 999999)),
                Colors.orange.shade700),
            _Row('Mortality', '$totalMortality birds', Colors.red.shade400),
          ]),
          const SizedBox(height: 12),
          ...
          if (expCats.isNotEmpty) ...[
            _SummaryCard(
                ...
                rows: expCats.entries
                    .map((e) =>
                        _Row(e.key, formatMoney(e.value), Colors.red.shade400))
                    .toList()),
            const SizedBox(height: 12),
          ],
          ...
          if (monthSales.isNotEmpty) ...[
            ...
            ...monthSales.map((s) => Card(
                  ...
                  subtitle: Text(
                      '${formatDate(s.date)} · ${formatEggs(s.totalEggs)}',
          ...
          if (monthSales.isEmpty && monthExpenses.isEmpty)
            Padding(
                    ...
                    children: [
                      ...
                      Text(r.value,
                          style: TextStyle(
                              color: r.color,
                              fontWeight:
                                  r.bold ? FontWeight.bold : FontWeight.w600,
