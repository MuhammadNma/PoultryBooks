...
//     final income = (crates * cratePrice) + piecesIncome;
//     final feedCostCalc =
...
//     setState(() {
//       profit = result.toDouble();
//       eggIncome = income.toDouble();
//       feedCost = feedCostCalc.toDouble();
//       fixedCostPerDay = fixedCost.toDouble();
//       _hasCalculated = true;
//     });
//   }
...
//     setState(() {}); // call this after deletion to refresh list
//   }
...
//                             onChanged: (val) =>
//                                 setState(() => showOtherCosts = val ?? false)),
...
//                             value: showAdvanced,
//                             onChanged: (val) =>
//                                 setState(() => showAdvanced = val ?? false)),
//                         const Text('Show Advanced (Bird & Housing)'),
//                       ],
//                     ),
//                     if (showAdvanced) ...[
//                       NumberField(
//                           controller: inputs.numberOfBirds,
//                           label: 'Number of Birds'),
//                       NumberField(
//                           controller: inputs.costPerBird,
//                           label: 'Cost per Bird',
//                           prefixText: '₦'),
//                       NumberField(
//                           controller: inputs.layingPeriodDays,
//                           label: 'Laying Period (days)'),
//                       NumberField(
//                           controller: inputs.housingCost,
//                           label: 'Housing Cost',
//                           prefixText: '₦'),
//                       NumberField(
...
//                       NumberField(
//                           controller: inputs.equipmentCost,
...
//                       NumberField(
//                           controller: inputs.mortalityCost,
...
//                 itemCount: profitController.records.length,
//                 itemBuilder: (context, index) {
//                   final record = profitController.records[index];
