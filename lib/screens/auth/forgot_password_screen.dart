  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: Padding(padding: const EdgeInsets.all(24), child: _sent
      ? Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const Text('Reset link sent!', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          Text('Check your inbox at ${_emailCtrl.text.trim()}', textAlign: TextAlign.center,
      ...
      : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(width: double.infinity,
            child: ElevatedButton(onPressed: _loading ? null : _send,
