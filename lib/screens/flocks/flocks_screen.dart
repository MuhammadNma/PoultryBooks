...
class FlocksScreen extends StatelessWidget {
  ...
  void _openForm(BuildContext context, Flock? flock) =>
      Navigator.push(context, MaterialPageRoute(
          builder: (_) => FlockFormScreen(existing: flock)));

  void _confirmDelete(BuildContext context, Flock flock) {
    showDialog(context: context, builder: (_) => AlertDialog(
      title: const Text('Delete Flock?'),
      content: Text(
          'Delete "${flock.name}"? Daily logs will remain.'),
      actions: [
        TextButton(
            ...
            itemBuilder: (_) => [
              const PopupMenuItem(value: 'edit',
                  child: ListTile(dense: true,
                      ...
                      title: Text('Edit'))),
              const PopupMenuItem(value: 'mortality',
                  child: ListTile(dense: true,
...
class FlockFormScreen extends StatefulWidget {
  ...
  @override State<FlockFormScreen> createState() =>
      _FlockFormScreenState();
}
...
class _FlockFormScreenState extends State<FlockFormScreen> {
  ...
  Future<void> _save() async {
    if (_nameCtrl.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Flock name required')));
      return;
    }
    final flock = Flock(
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(title: Text(
        widget.existing != null ? 'Edit Flock' : 'Add Flock')),
